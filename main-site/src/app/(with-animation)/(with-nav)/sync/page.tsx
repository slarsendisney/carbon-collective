      ...
      <div className="flex items-center justify-center grow bg-blue-100">
        <div className="card">
          ...
          <p className="text-center">
            Before continuing, please install our extension from the chrome web
            store. This page will automatically refresh once installed.
          </p>
          <Link
            href="/download"
  ...
  return (
    <div className="flex items-center justify-center grow bg-blue-100">
      <div className="card">
        ...
        <p className="text-center">
          Nice work! It looks like you already have our chrome extension. Click
          the button below to link your account with the installed extension.
        </p>
        <Link
          href="/link"
          className="bg-blue-600 rounded-full text-white px-4 py-1 flex space-x-2 items-center justify-center"
